// dnSpy decompiler from Assembly-CSharp.dll class: slugger
using System;
using System.Collections;
using ControlFreak2;
using UnityEngine;

public class slugger : FPSCommonWeaponSpecs
{
	private void Awake()
	{
	...
	private IEnumerator ejectshell(float waitTime)
	{
		...
		shellInstance.GetComponent<Rigidbody>().AddRelativeForce(20f, 80f, 0f);
		shellInstance.GetComponent<Rigidbody>().AddRelativeTorque(35f, 45f, 0f);
		yield break;
	}
