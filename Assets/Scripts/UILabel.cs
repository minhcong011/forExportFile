// dnSpy decompiler from Assembly-CSharp.dll class: UILabel
using System;
...
public class UILabel : UIWidget
{
	...
	public UnityEngine.Object ambigiousFont
	{
		get
		{
			return (!(this.mFont != null)) ? this.mTrueTypeFont :(UnityEngine.Object) this.mFont;
		}
		set
		{
		...
		if (this.mActiveTTF != fnt)
		{
			...
			if (this.mActiveTTF != null)
			{
				...
				if (!UILabel.mFontUsage.TryGetValue(this.mActiveTTF, out num2))
				{
					...
					if (UILabel._003C_003Ef__mg_0024cache0 == null)
					{
						UILabel._003C_003Ef__mg_0024cache0 = new Font.FontTextureRebuildCallback(UILabel.OnFontTextureChanged);
					}
					font.textureRebuildCallback = UILabel._003C_003Ef__mg_0024cache0;
				}
