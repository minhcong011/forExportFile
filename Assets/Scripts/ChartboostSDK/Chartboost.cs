// dnSpy decompiler from Assembly-CSharp.dll class: ChartboostSDK.Chartboost
using System;
...
namespace ChartboostSDK
{
	public class Chartboost : MonoBehaviour
	{
		...
		private static void disableUI(bool pause)
		{
			...
			{
				Chartboost.kEventSystem = EventSystem.current;
				Chartboost.kEventSystem.enabled = false;
			}
			else if (!pause && Chartboost.kEventSystem)
			{
				Chartboost.kEventSystem.enabled = true;
				EventSystem.current = Chartboost.kEventSystem;
			}
		}
