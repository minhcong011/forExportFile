// dnSpy decompiler from Assembly-CSharp.dll class: UIPanel
using System;
...
public class UIPanel : UIRect
{
	...
	public int depth
	{
		...
		set
		{
			if (this.mDepth != value)
			{
				...
				if (UIPanel._003C_003Ef__mg_0024cache0 == null)
				{
					UIPanel._003C_003Ef__mg_0024cache0 = new Comparison<UIPanel>(UIPanel.CompareFunc);
				}
				list.Sort(UIPanel._003C_003Ef__mg_0024cache0);
			}
		}
	}
	...
	public override Vector3[] worldCorners
	{
		get
		{
			...
			else
			{
				...
				{
					Vector3[] worldCorners = this.mCam.GetWorldCorners(base.cameraRayDistance);
	...
	protected override void OnInit()
	{
		...
		List<UIPanel> list = UIPanel.list;
		if (UIPanel._003C_003Ef__mg_0024cache1 == null)
		{
			UIPanel._003C_003Ef__mg_0024cache1 = new Comparison<UIPanel>(UIPanel.CompareFunc);
		}
		list.Sort(UIPanel._003C_003Ef__mg_0024cache1);
	}
	...
	public void SortWidgets()
	{
		...
		if (UIPanel._003C_003Ef__mg_0024cache2 == null)
		{
			UIPanel._003C_003Ef__mg_0024cache2 = new Comparison<UIWidget>(UIWidget.PanelCompareFunc);
		}
		list.Sort(UIPanel._003C_003Ef__mg_0024cache2);
	}
