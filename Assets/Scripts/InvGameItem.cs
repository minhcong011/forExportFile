// dnSpy decompiler from Assembly-CSharp.dll class: InvGameItem
using System;
...
public class InvGameItem
{
	...
	public List<InvStat> CalculateStats()
	{
		...
		if (this.baseItem != null)
		{
			...
			if (InvGameItem._003C_003Ef__mg_0024cache0 == null)
			{
				InvGameItem._003C_003Ef__mg_0024cache0 = new Comparison<InvStat>(InvStat.CompareArmor);
			}
			list2.Sort(InvGameItem._003C_003Ef__mg_0024cache0);
		}
		return list;
	}
	...
	[CompilerGenerated]
	private static Comparison<InvStat> _003C_003Ef__mg_0024cache0;
