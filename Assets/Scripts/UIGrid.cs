// dnSpy decompiler from Assembly-CSharp.dll class: UIGrid
using System;
	...
	public List<Transform> GetChildList()
	{
		...
		if (this.sorting != UIGrid.Sorting.None)
		{
			if (this.sorting == UIGrid.Sorting.Alphabetic)
			{
				...
				if (UIGrid._003C_003Ef__mg_0024cache0 == null)
				{
					UIGrid._003C_003Ef__mg_0024cache0 = new Comparison<Transform>(UIGrid.SortByName);
				}
				list2.Sort(UIGrid._003C_003Ef__mg_0024cache0);
			}
			else if (this.sorting == UIGrid.Sorting.Horizontal)
			{
				List<Transform> list3 = list;
				if (UIGrid._003C_003Ef__mg_0024cache1 == null)
				{
					UIGrid._003C_003Ef__mg_0024cache1 = new Comparison<Transform>(UIGrid.SortHorizontal);
				}
				list3.Sort(UIGrid._003C_003Ef__mg_0024cache1);
			}
			else if (this.sorting == UIGrid.Sorting.Vertical)
			{
				List<Transform> list4 = list;
				if (UIGrid._003C_003Ef__mg_0024cache2 == null)
				{
					UIGrid._003C_003Ef__mg_0024cache2 = new Comparison<Transform>(UIGrid.SortVertical);
				}
				list4.Sort(UIGrid._003C_003Ef__mg_0024cache2);
			}
