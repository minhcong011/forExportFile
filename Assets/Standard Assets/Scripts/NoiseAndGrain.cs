// dnSpy decompiler from Assembly-UnityScript-firstpass.dll class: NoiseAndGrain
using System;
using UnityEngine;
...
public class NoiseAndGrain : PostEffectsBase
{
	...
	public virtual void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		if (!this.CheckResources() || null == this.noiseTexture)
		{
			...
			{
				UnityEngine.Debug.LogWarning("Noise & Grain effect failing as noise texture is not assigned. please assign.", this.transform);
			}
		}
		else
		{
