// dnSpy decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.TouchMarkerGUI
using System;
...
namespace ControlFreak2
{
	public class TouchMarkerGUI : MonoBehaviour
	{
		...
		{
			TouchMarkerGUI.mInst = this;
		}

		private void OnDisable()
		{
			if (TouchMarkerGUI.mInst == this)
			{
				TouchMarkerGUI.mInst = null;
			}
		}
