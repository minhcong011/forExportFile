// dnSpy decompiler from Assembly-UnityScript-firstpass.dll class: ThirdPersonCamera
using System;
using UnityEngine;
...
public class ThirdPersonCamera : MonoBehaviour
{
	...
	public virtual void Awake()
	{
		...
		{
			UnityEngine.Debug.Log("Please assign a camera to the ThirdPersonCamera script.");
			this.enabled = false;
		}
		...
		{
			UnityEngine.Debug.Log("Please assign a target to the camera that has a ThirdPersonController script attached.");
		}
	...
	{
		UnityEngine.Debug.DrawLine(this._target.position, this._target.position + this.headOffset);
	}
	...
	public virtual void SetUpRotation(Vector3 centerPos, Vector3 headPos)
	{
		...
		Ray ray2 = this.cameraTransform.GetComponent<Camera>().ViewportPointToRay(new Vector3(0.5f, this.clampHeadPositionScreenSpace, (float)1));
