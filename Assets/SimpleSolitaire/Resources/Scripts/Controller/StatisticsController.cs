...
public class StatisticsController : MonoBehaviour
{
    ...
    public string GameVersion
    {
        ...
        set { _gameVersion = value; GameVersionText.text = _gameVersion; }
    }
    ...
    {
        SaveStat += SaveStaticticInPrefs;
        GetStat += GetStaticticFromPrefs;
    ...
    /// </summary>
    private void SaveStaticticInPrefs()
    {
        switch (_cardLogicComponent.CurrentRule)
        {
    ...
    /// </summary>
    private void GetStaticticFromPrefs()
    {
    ...
    /// </summary>
    public void IncreasePlayedGamesAmount()
    {
        PlayedGamesAmount++;
        SaveStaticticInPrefs();
    }
    ...
    {
        if (CurrentStatisticRule != _cardLogicComponent.CurrentRule) return;
