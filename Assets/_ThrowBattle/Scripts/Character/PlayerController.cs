...
namespace _ThrowBattle
{
    public class PlayerController : MonoBehaviour
    {
        ...
        public void RevivalPlayer(int playerSide)
        {
            Character player1 = players[playerSide].GetComponent<Character>();
            player1.Healing(30);
            UpdatePlayerHealth();
        ...
        {
            if (newState == GameState.StartPlaying)
            {
                Debug.Log("a");
        ...
        {
            if (GameManager.Instance.GameState == GameState.PreGameOver || GameManager.Instance.GameState == GameState.GameOver) return;
