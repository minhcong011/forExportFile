...
namespace _ThrowBattle
{
    public class Character : MonoBehaviour
    {
        ...
        void CheckHealth()
        {
            ...
            {              
                ...
                if (!waitFinishShot && !isDead)
                {
                    ...
                    if (GameManager.Instance.GameState == GameState.PreGameOver) return;
                    isDead = true;
                    waitFinishShot = true;
        ...
        private void Update()
        {
            if (isChangeTurn && GameManager.Instance.GameState == GameState.Playing)
            {
        ...
        public void Healing(int percent)
        {
            health += originalHealth * percent / 100;
        }
    }
}