...
namespace _ThrowBattle
{
    ...
    public class TargetObject : MonoBehaviour {
        public RewardInGame objectReward;
        public int coins;
        public float time;
