...
// Unity.Services.Core.ServicesCreationException
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Unity.Services.Core.ServicesCreationException::.ctor(System.String)
...
IL_00ad_1:
		{
			...
			InitializationOptions_t51AA79A729CADA6922543A7A47F1E87A09DBD17A* L_22 = __this->___options_2;
			NullCheck(L_21);
			Task_t751C4CC3ECD055BABA8A0B6A5DFBB4283DCA8572* L_23;
			L_23 = InterfaceFuncInvoker1< Task_t751C4CC3ECD055BABA8A0B6A5DFBB4283DCA8572*, InitializationOptions_t51AA79A729CADA6922543A7A47F1E87A09DBD17A* >::Invoke(1 /* System.Threading.Tasks.Task Unity.Services.Core.IUnityServices::InitializeAsync(Unity.Services.Core.InitializationOptions) */, IUnityServices_t49EC0D24FF18A25F42A1FF0B56962B5E7AD1E9A9_il2cpp_TypeInfo_var, L_21, L_22);
			NullCheck(L_23);
...
IL_00ec_1:
		{
			...
			V_2 = L_29;
			TaskAwaiter_t9B661AC8C2EFA6BAB94C77BB24A5DDA82D61F833* L_30 = (&__this->___U3CU3Eu__2_4);
